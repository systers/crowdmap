		...
		<ul id="header_nav_right">
			...
			<?php if($loggedin_user != FALSE){ ?>
				...
				<a href="<?php echo url::site().$loggedin_role;?>">
					...
					<img alt="<?php echo html::escape($loggedin_user->username); ?>" src="<?php echo html::escape(members::gravatar($loggedin_user->email, 25)); ?>" width="25" />
				</a>
			...
			<?php } else { ?>
				...
				<a href="<?php echo url::site('login');?>"><span class="header_nav_label"><strong><?php echo Kohana::lang('ui_main.login'); ?></strong></span></a>
